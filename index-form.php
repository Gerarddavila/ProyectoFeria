									...
									<div class="panel-body">									   
    					                <form action="" method="post" role="form" class="contactForm lead">    									
    										...
    										$candidata=$_GET['ref'];
    											...
    											echo"<a  href='index-formBaño.php?ref=" .$candidata."' class='btn btn-skin btn-block btn-lg'>Traje Típico</a>";
    											...
    											echo"<a  href='index-formentre.php?ref=" .$candidata."' class='btn btn-skin btn-block btn-lg'>Mensaje	</a>";
